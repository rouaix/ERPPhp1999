...
if(!isset($_SESSION["arbre"]["user"])){repertoire_liste("fichiers/users/".$_SESSION["userid"]."/","user");}

if(!isset($_SESSION["rep"]) or @$_SESSION["rep"]== ""){$_SESSION["rep"] = "fichiers/users/".$_SESSION["userid"]."/";}

if(strrpos(@$_SESSION["rep"], "fichiers/users/".$_SESSION["userid"]) === false){
  $_SESSION["rep"] = "fichiers/users/".$_SESSION["userid"]."/";
}
