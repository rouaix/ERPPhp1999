...
if($_SESSION["vue"] != "mois" && $_SESSION["vue"] != "an"){
  if(@$_SESSION["tout"]== "o"){
...
if(file_exists("scripts/modules/agenda/inc.agenda.".$_SESSION["vue"].".php")){
  include("scripts/modules/agenda/inc.agenda.".$_SESSION["vue"].".php");
